...
public class GiaoCaViewModel {
    ...
    public GiaoCaViewModel(String maca, Date thoigianbatdau, String idnhanvien) {
        this.maca = maca;
        this.thoigianbatdau = thoigianbatdau;
        this.idnhanvien = idnhanvien;
    }

    public GiaoCaViewModel(String maca, Date thoigianbatdau, double tienbandau, String idnhanvien) {
        this.maca = maca;
        this.thoigianbatdau = thoigianbatdau;
